...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Artificial Strip Chart.vi" Type="VI" URL="../Artificial Strip Chart.vi"/>
		<Item Name="Create and Format PNG Image Link.vi" Type="VI" URL="../Create and Format PNG Image Link.vi"/>
		<Item Name="Create Example PNG.vi" Type="VI" URL="../Create Example PNG.vi"/>
		<Item Name="Create Header and Table Definition Constant.vi" Type="VI" URL="../Create Header and Table Definition Constant.vi"/>
		<Item Name="Create PassFail Markdown List.vi" Type="VI" URL="../Create PassFail Markdown List.vi"/>
		<Item Name="Format Markdown Header.vi" Type="VI" URL="../Format Markdown Header.vi"/>
		<Item Name="Format Markdown Paragraph.vi" Type="VI" URL="../Format Markdown Paragraph.vi"/>
		<Item Name="Format Markdown Table.vi" Type="VI" URL="../Format Markdown Table.vi"/>
		<Item Name="Format PassFail Markdown List Item.vi" Type="VI" URL="../Format PassFail Markdown List Item.vi"/>
		<Item Name="Write to Markdown File.vi" Type="VI" URL="../Write to Markdown File.vi"/>
